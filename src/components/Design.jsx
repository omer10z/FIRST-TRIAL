  ...
  return (
    <div>
      ...
      <div className="relative bg-white min-h-[50vh] flex justify-start items-center p-8 hover:bg-[#3b3b3a] group ">
        <img src={residentimg} alt="" className="ml-24 mt-8" />
        <div className="ml-8">
          <h1 className="text-black text-5xl font-semibold group-hover:text-white transition">
            Residential
          </h1>
          <h1 className="text-black text-5xl font-semibold mt-4 group-hover:text-white transition">
            Design
          </h1>
        </div>
        <div className="ml-12">
          <div className="ml-8">
            <p className="  font-semibold text-lg text-[#84807e] group-hover:text-[#84807e] transition -mt-[0.8rem]">
              They choose color schemes, materials, and furnishings
            </p>
            <div className="flex items-center mt-2">
              <p className="font-semibold text-lg text-[#84807e] group-hover:text-[#84807e] transition -mt-[2rem]">
            ...
            <p className="font-semibold text-lg text-[#84807e] group-hover:text-[#84807e] transition  -mt-[1.5rem]">
      ...
      <div className="relative bg-white min-h-[50vh] flex justify-start items-center p-8 hover:bg-[#3b3b3a] group">
        <img src={spaceimg} alt="" className="ml-24 mt-8" />
        <div className="ml-8">
          <h1 className="text-black text-5xl font-semibold group-hover:text-white transition">
            Space
          </h1>
        ...
        <div className="ml-24">
          <div className="ml-8 mt-[0.1rem]">
            <p className="font-semibold text-lg text-[#84807e]  group-hover:text-[#84807e] transition -mt-[0.9rem]">
      ...
      <div className="relative bg-white min-h-[50vh] flex justify-start items-center p-8 hover:bg-[#3b3b3a] group">
        <img src={commercialimg} alt="" className="ml-24 mt-8" />
        <div className="ml-8">
          <h1 className="text-black text-5xl font-semibold group-hover:text-white transition">
            Commercial
          </h1>
      ...
      <div className="flex justify-center mt-8">
        <button className="border-2 border-black bg-white text-black  rounded-full py-2 px-6 hover:bg-gray-400 transition duration-200">
          See more
        </button>
      </div>
    </div>
